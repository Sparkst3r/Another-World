...
public class EntityUtils {
	...
	public static boolean isEntityItem(EntityItem entityItem, Item item, int meta) {
		...
		if (entityStack.getItem().getUnlocalizedName().equals(item.getUnlocalizedName()) && entityStack.getItemDamage() == itemStack.getItemDamage()) {
			return true;
		}
		return false;
	}
	...
	public static void dropItemInWorld(World world, int x, int y, int z, ItemStack stack) {
		if (stack != null) {
			...
			EntityItem entityitem;
                ...
                entityitem = new EntityItem(world, (double)(x + xOffset), (double)(y + yOffset), (double)(z + zOffset), new ItemStack(stack.getItem(), itemCount, stack.getItemDamage()));
