package com.sparkst3r.anotherworld.network;
...
private boolean isPostInitialised = false;
	...
	*/
	...
	protected void encode(ChannelHandlerContext ctx, AbstractPacket packet, List<Object> out) throws Exception {
		...
		Class<? extends AbstractPacket> clazz = packet.getClass();
	...
	@Override
	protected void decode(ChannelHandlerContext context, FMLProxyPacket packet, List<Object> out) throws Exception {
		...
		pkt.decodeInto(context, payload.slice());
	...
	public void registerPackets(){
		this.registerPacket(PacketManualCrusher.class);
	}
