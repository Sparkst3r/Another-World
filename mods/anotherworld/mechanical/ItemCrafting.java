...
public class ItemCrafting {
	...
	public static void initialise() {
		...
		/** Basic Gear */
		GameRegistry.addRecipe(new ItemStack(MechanicalValues.ItemBasePartsField, 1, 0),
			"WSW", "SRS", "WSW", 'W', new ItemStack(Item.stick), 'S', new ItemStack(Block.stone), 'R', new ItemStack(Item.redstone));
		
		/** Copper Gear */
		GameRegistry.addRecipe(new ItemStack(MechanicalValues.ItemBasePartsField, 1, 1),
			" C ", "CGC", " C ", 'C', new ItemStack(WorldValues.ItemIngotField, 1, 0), 'G', new ItemStack(MechanicalValues.ItemBasePartsField, 1, 0));
