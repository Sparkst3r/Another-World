...
public class BlockMechanicsTableParts extends Block{
	...
	public void registerIcons(IconRegister ir) {
		...
		iconBuffer[0][2] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		iconBuffer[0][3] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		...
		iconBuffer[1][2] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide1");
		iconBuffer[1][3] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide1");
		iconBuffer[1][4] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		iconBuffer[1][5] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		...
		iconBuffer[2][3] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide1");
		iconBuffer[2][4] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		iconBuffer[2][5] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide2");
		...
		iconBuffer[3][4] = ir.registerIcon(GlobalValues.TEXTURE + "blockTableSide1");
