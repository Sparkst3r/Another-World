...
public class SpecialCrafting {
	...
	public static void initialise() {
		...
		Managers.manualCrusher.addRecipe(new ItemStack(Item.netherQuartz, 1, 0), new ItemStack(MechanicalValues.ItemBasePartsField, 1, 6));
		...
		Managers.manualCrusher.addRecipe(new ItemStack(WorldValues.ItemIngotField, 2, 8), new ItemStack(Block.oreIron, 1, 0));
		Managers.manualCrusher.addRecipe(new ItemStack(WorldValues.ItemIngotField, 2, 9), new ItemStack(Block.oreGold, 1, 0));
