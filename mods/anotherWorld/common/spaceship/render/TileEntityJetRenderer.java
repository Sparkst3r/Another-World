...
public class TileEntityJetRenderer extends TileEntitySpecialRenderer
{
    /** The normal small chest model. */
    private ModelJet jetModel = new ModelJet();

    public TileEntityJetRenderer()
    {
     ...
     */
    public void renderTileEntityJetAt(TileEntityJet par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        ModelJet modeljet = this.jetModel;
                    ...
                    this.bindTextureByName("/mods/anotherWorld/textures/entities/jet.png");
    ...
    {
        this.renderTileEntityJetAt((TileEntityJet)par1TileEntity, par2, par4, par6, par8);
    }
}