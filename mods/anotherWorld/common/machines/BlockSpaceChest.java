...
public class BlockSpaceChest extends BlockContainer
{
    ...
    protected BlockSpaceChest(int par1, int par2)
    {
        ...
        GameRegistry.registerBlock(this, "da");
        LanguageRegistry.addName(this, "da");
    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntitySpaceChest)par1World.getBlockTileEntity(par2, par3, par4)).func_94043_a(par6ItemStack.getDisplayName());
        }
    }
     ...
     */
    private boolean isThereANeighborChest(World world, int x, int y, int par4)
    {
        return world.getBlockId(x, y, par4) != this.blockID ? false : (world.getBlockId(x - 1, y, par4) == this.blockID ? true : (world.getBlockId(x + 1, y, par4) == this.blockID ? true : (world.getBlockId(x, y, par4 - 1) == this.blockID ? true : world.getBlockId(x, y, par4 + 1) == this.blockID)));
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntitySpaceChest tileentitychest = (TileEntitySpaceChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntitySpaceChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
